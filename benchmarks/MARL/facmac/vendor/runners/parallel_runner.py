...
class ParallelRunner:
    ...
    def run(self, test_mode=False, **kwargs):
        ...
        # Vendor's original code used only self.parent_conns[0:1] in training mode.
        # That meant 6 of our 7 workers sat idle, feeding the replay buffer with
        # near-empty episodes that crashed the learner on sampling. We unify the
        # two paths so all workers step in both modes.
