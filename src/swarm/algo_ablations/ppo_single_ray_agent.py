"""
Single-agent PPO RLModule spec and catalog using Swarm's IMPALA + heads.
"""
...
DEFAULT_PPO_SINGLE_AGENT_MODEL_CONFIG: Dict = {
    "backbone": {
        "type": "IMPALA",
        "feature_size": 256,
...
class SingleAgentPPOCatalog(PPOCatalog):
    """PPO catalog that supports Dict observations with image + voltage."""
...
def build_single_agent_ppo_module_spec(
    observation_space: gym.Space,
    action_space: gym.Space,
    model_config: Dict = None,
) -> RLModuleSpec:
    """Create RLModuleSpec for single-agent PPO using Swarm's IMPALA encoder."""
    ...
    return RLModuleSpec(
        ...
        catalog_class=SingleAgentPPOCatalog,
