...
from .simple_q import SimpleQ, SimpleQConfig
...
class DDPG(SimpleQ):
    ...
    def get_default_policy_class(
        ...
        if config["framework"] == "torch":
            from .ddpg_torch_policy import DDPGTorchPolicy

            return DDPGTorchPolicy
        else:
            raise RuntimeError("Only the PyTorch DDPG policy is supported in this ablation stub.")
