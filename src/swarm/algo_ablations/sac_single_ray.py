#!/usr/bin/env python3
"""
Single-agent SAC training with Ray RLlib on SingleAgentWrapper.

Uses RLlib's SAC implementation (no custom training loop beyond calling algo.train()).
"""
...
from swarm.algo_ablations.sac_single_ray_agent import (
    build_single_agent_sac_module_spec,
    DEFAULT_SAC_SINGLE_AGENT_MODEL_CONFIG,
)
from swarm.training.utils.metrics_logger import print_training_progress

ENV_ID = "SingleAgentRaySAC-v0"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="RLlib SAC on SingleAgentWrapper")
