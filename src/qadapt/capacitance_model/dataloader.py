...
from qadapt.capacitance_model.capacitance_utils import get_channel_targets, get_nearest_targets, get_targets_with_nnn
...
if __name__ == "__main__":
    ...
    # Test the dataset
    data_dir = "src/qadapt/qarray_dataset/barrier_dataset_2"
