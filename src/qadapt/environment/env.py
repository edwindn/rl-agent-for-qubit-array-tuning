...
from qadapt.environment.qarray_base_class import QarrayBaseClass
from qadapt.environment.utils.fake_capacitance import fake_capacitance_model
...
from qadapt.capacitance_model import CapacitancePredictionModel
...
class QuantumDeviceEnv(gym.Env):
    ...
    def _init_capacitance_model(self):
        ...
        try:
            ...
            if "QADAPT_PROJECT_ROOT" in os.environ:
                # Ray distributed mode: use environment variable set by training script
                swarm_dir = os.environ["QADAPT_PROJECT_ROOT"]
            ...
            if update_method in {"bayesian", "kriging", "ema"}:
                ...
                if update_method == "kalman":
                    from qadapt.capacitance_model.KalmanUpdater import KalmanCapacitanceUpdater
                    updater_cls = KalmanCapacitanceUpdater
                else:
                    from qadapt.capacitance_model.DirectUpdater import DirectCapacitanceUpdater
