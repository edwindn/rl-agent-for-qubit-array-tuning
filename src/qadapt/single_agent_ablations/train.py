...
def main():
    ...
    try:
        ...
        # Filter training parameters (remove SAC-only params)
        sac_only_params = {
        ...
        # is unchanged. Mirrors main.py's pattern: use local eval (no remote
        # env runner) to avoid the Ray 2.51 race + the PPO+IMPALA stall we hit
