...
class PolicyHeadConfig(MLPHeadConfig):
    ...
    def build(self, framework: str = "torch"):
        ...
        from qadapt.voltage_model.models.heads import PolicyHead
...
class ValueHeadConfig(MLPHeadConfig):
    ...
    def build(self, framework: str = "torch"):
        if framework != "torch":
            raise ValueError(f"Only torch framework supported, got {framework}")
        from qadapt.voltage_model.models.heads import ValueHead
...
class QValueHeadConfig(MLPHeadConfig):
    ...
    def build(self, framework: str = "torch"):
        if framework != "torch":
            raise ValueError(f"Only torch framework supported, got {framework}")
        from qadapt.voltage_model.models.heads import QValueHead
...
class DeterministicPolicyHeadConfig(MLPHeadConfig):
    ...
    def build(self, framework: str = "torch"):
        if framework != "torch":
            raise ValueError(f"Only torch framework supported, got {framework}")
        from qadapt.voltage_model.models.heads import DeterministicPolicyHead
