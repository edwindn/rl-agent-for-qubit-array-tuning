...
from qarray.DotArrays.GateVoltageComposer import GateVoltageComposer

from qarray.DotArrays._helper_functions import check_algorithm_and_implementation, \
...
from .ground_state_advanced_latching import _ground_state_open

@dataclass
class AdvancedLatching:
    """
    A class that represents a charge sensed dot array. The class has methods to compute the ground state of the dot array
    and the charge sensor output for both open and closed dot arrays.
